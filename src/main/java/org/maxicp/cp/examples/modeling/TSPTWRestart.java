...
import org.maxicp.cp.engine.nogoods.Restarter;
...
public class TSPTWRestart {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            IntExpression arrivalPlusTransition = sum(arrival[i], transition[i]); // arrivalPlusTransition[i] =
                                                                                  // arrival[i] + transition[i]
