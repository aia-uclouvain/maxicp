 ...
 */
public class CPIntervalVarImplNaive implements CPIntervalVar {
    ...
    public CPIntervalVarImplNaive(CPSolver cp) {
        this.cp = cp;
    ...
    public int endMin() {
        ...
        return startMin.value() + lengthMin.value();
        //return endMin.value();
    }
    ...
    public int endMax() {
        ...
        return Math.min(HORIZON,startMax.value() + lengthMax.value());
    }
