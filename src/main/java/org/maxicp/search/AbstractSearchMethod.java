...
public abstract class AbstractSearchMethod<T> implements SearchMethod {
    ...
    protected List<Consumer<SearchStatistics>> failureListeners = new LinkedList<>();
     ...
     * This happens when a {@link InconsistencyException} is thrown
    ...
    protected void notifyFailure(SearchStatistics stats) {
        failureListeners.forEach(c -> c.accept(stats));
    }
