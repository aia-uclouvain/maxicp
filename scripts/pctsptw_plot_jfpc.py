...
for i in range(n_methods-1):
    ...
    # actual values
    axs[(0, i)].scatter(list_for_j_when_i_better, list_for_i_when_i_better, color=VERMILION, alpha=alpha, s=markersize)
    axs[(0, i)].scatter(list_for_j_when_j_better, list_for_i_when_j_better, color=SKY_BLUE, alpha=alpha, s=markersize)
    axs[(0, i)].scatter(list_for_j_when_equal, list_for_i_when_equal, color=BLACK, alpha=alpha, s=markersize)
...
for i in range(n_methods-1):
    ...
    # actual values
    axs[(1, i)].scatter(list_for_j_when_i_better, list_for_i_when_i_better, color=VERMILION, alpha=alpha, s=markersize)
    axs[(1, i)].scatter(list_for_j_when_j_better, list_for_i_when_j_better, color=SKY_BLUE, alpha=alpha, s=markersize)
    axs[(1, i)].scatter(list_for_j_when_equal, list_for_i_when_equal, color=BLACK, alpha=alpha, s=markersize)
