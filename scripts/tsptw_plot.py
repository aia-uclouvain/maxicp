...
filenames = [
    ("results/tsptw/tsptw-2026-02-09_21-45-34-abc2366bc",
        {"MEAN_INPUT_AND_OUTPUT_SUM",
         "MIN_DETOUR",
         "MST_DETOUR",
         "MST_DETOUR_SHAVING",
         "ORIGINAL",
...
plt.savefig("plot/tsptw_cactus_plot.pdf")
plt.show()
...
fig.set_figwidth(cm_to_inch(14))
plt.tight_layout()
plt.savefig("plot/tsptw_gap_over_time.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("plot/tsptw_runtime_comparison.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("plot/tsptw_nodes_comparison.pdf")
plt.show()
